...
/*
 * Modifications Tobias Scharnowski (2021-11-19):
 * 1. Pre-set compiler type Stripped some includes and definitions.
 * 2. Commented out client-side HAL functions.
 */
...
// Tobias Scharnowski: Force options to pull in defines such as __STATIC_INLINE
